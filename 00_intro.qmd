...
![Screenshot of the R Terminal Window (Source: \[Wikipedia\](https://commons.wikimedia.org/w/index.php?curid=90393195))](images/rterminal.png){alt="Screenshot of the R Terminal Window (Source: [Wikipedia](https://commons.wikimedia.org/w/index.php?curid=90393195))" fig-alt="Screenshot of the R Terminal Window"}
...
![Screenshot of RStudio IDE window (Source: [Wikipedia](https://commons.wikimedia.org/w/index.php?curid=101293607))](images/rstudio.png){alt="Screenshot of RStudio IDE window (Source: Wikipedia)" fig-alt="Screenshot of RStudio IDE window"}
