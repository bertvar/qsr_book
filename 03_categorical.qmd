...
A ggplot object is in this sense composed of multiple components that are layered on top of each other to produce the final data visualisation.

bar charts easily using the *geom_bar* option. The basic syntax is as follows:
